...
export class AskUmeController {
  ...
  async ask(
    ...
    const system =
      ...
      `4c. approval_status is an administrative workflow, never payment evidence. approval_status="paid" means APPROVED FOR PAYMENT, not paid. Only Payment records prove payment. Never say an invoice was paid because its approval status says paid.
` +
