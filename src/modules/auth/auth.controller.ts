...
export class AuthController {
  ...
  setPermissions(
    @Param('id') id: string,
    @Body() body: { allowed_screens: string[] },
    @Request() req: any,
  ) {
    ensureAdmin(req);
  ...
  setRole(
    @Param('id') id: string,
    @Body() body: { role: string; allowed_screens?: string[] },
    @Request() req: any,
  ) {
    ensureAdmin(req);
